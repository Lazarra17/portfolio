<?php
  ...
  if(isset($_POST['submit'])){
    ...
    if (!is_numeric($zip)){
       ...
       editEmployeeAccount($id, $lname, $fname, $mname, $gender,$dept, $bday, $address, $region, $city, $zip, $contact);
      }
    }
  }
   ...
   if(isset($_POST['changePassword'])){
    $username= data_secure($_POST['username']);
    $emp_id_no = $_SESSION["emp_id_no"];
    
   header("Location: update-password.php?username=$username&emp_id_no=$emp_id_no");
     ...
     <div class="col s12" style="margin-left: 5%;">
      <div class="container white z-depth-2" style="margin-top: 2%;height:auto; padding-top: 1%; padding-bottom: 3%;">
        ...
        (Note: All fields with <b>" * "</b> is required)<br><br>
            ...
            <div class="input-field col s4">
                <input id="email" type="email" readonly="" class="validate" name="email"  require required maxlength="40" value="<?php echo empData($id, 'email'); ?>">
                <label for="email">* Email</label>
            </div>
            
               <div class="input-field col s4">
                <input id="username" type="text" readonly="" class="validate" name="username"  require required maxlength="12" value="<?php echo empData($id, 'username'); ?>">
               ...
               <div class="input-field col s6" >
                ...
                <input id="position" type="text" class="validate" readonly="" name="position"  require required maxlength="15" value="<?php echo empData($id, 'position'); ?>">
            ...
            <div class="input-field col s6" >
                ...
                <input id="lname" type="text" class="validate" readonly="" name="department"  require required maxlength="15" value="<?php echo empData($id, 'department'); ?>">
                <label for="department">* Department</label>
            </div>
            
             <div class="input-field col s4" style="margin-top: 0px;">
             <i style="font-size: 13px;">* Date Hired</i>
                <input id="Date Hired" type="date" readonly="" class="validate" name="datehired"  require required maxlength="15" value="<?php echo empData($id, 'date_hired'); ?>">
                <label for="Date Hired"></label>
            </div> 
            
            <div class="input-field col s4">
                <input id="salary" type="text" class="validate" readonly="" name="salary"  require required maxlength="12" value="<?php echo empData($id, 'salary'); ?>">
                <label for="Salary">* Salary</label>
            </div>
           
           
             <div class="input-field col s4">
                <input id="salary" type="text" class="validate" readonly="" name="status"  require required maxlength="12" value="<?php echo empData($id, 'status'); ?>">
          ...
          <button class="medium btn waves-effect waves-light green darken-3 left" type="submit" name="changePassword" style="margin-right: 125px;margin-left: 0px;">
            Change Password 
