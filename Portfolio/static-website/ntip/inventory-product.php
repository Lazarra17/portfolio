  ...
  ?>
    <div class="col s12" style="margin-left: 6%;">
      <div class="container white z-depth-2" style="margin-top: 2%; height:auto; width:70%; padding-top: 1%; padding-bottom: 3%;">
        <div class="row">
          <div class="col s12">
            <h4 style="letter-spacing: 2px;">Product Record</h4>
            ...
            $sql = "SELECT * FROM `products`";    
             ...
             ?>
                      ...
                      <tr>
                        ...
                        <td><a href="inventory-product-confirm.php?product_no=<?php echo $row["product_no"]?>" class="medium btn waves-effect waves-light green darken-0 left">Update</a></td>
                      </tr>
                  <?php
                    }
