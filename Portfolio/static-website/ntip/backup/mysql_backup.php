<?php session_start();
?>
<div class="back" style="position:absolute; left: 300px; top:50px">
<a href="../index.php"><img src="../images/home.gif" width="100" height="100" /></a>
</div>


<?php
// Open source in the internet https://github.com/vkt005/php-mysql-db-backup
...
if(isset($_REQUEST['submit'])){
        ...
        $todayoryt = $_SESSION["time_in_oryt"];
         ...
         $activity = "Made a mysql backup at " . date("h:i:sa");
...
$fileName = 'DBbackup--' . date('M-d-Y') . '@'.date('h.i.s').'.sql' ; 
    ...
    <div class="main">
        ...
        <fieldset><legend><h2>Database Backup</h2></legend>
            <form name="backup" id="backup" method="post">
                <div><label>Host:</label><input type="text" name="host" value="localhost" readonly="" /></div>
                <div class="cls"></div>
                <div><label>Database name:</label><input type="text" name="database" value="ntips" readonly="" /></div>
                <div class="cls"></div>
                <div><label>Database User:</label><input type="text" name="user" value="root" readonly="" /></div>
                <div class="cls"></div>
                <div><label>Database Password:</label><input type="text" name="password" value="" readonly="" /></div>
                <div class="cls"></div>
