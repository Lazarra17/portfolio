  ...
  ?>
    <div class="col s12" style="margin-left: 8%;">
      <div class="container white z-depth-2" style="margin-top: 2%; height:auto; width:75%; padding-top: 1%; padding-bottom: 3%;">
        <div class="row">
          <div class="col s12">
            <h4 style="letter-spacing: 2px;">Delete Customer Record</h4>
            ...
            OR customer_id='$search' OR gender='$search' OR city='$search' OR email='$search'";    
             ...
             ?>
                      ...
                      <tr>
                        ...
                        <td><a href="customer-delete.php?customer_id=<?php echo $row["customer_id"] . "&find=" . $search."&fullname=$row[fname] $row[lname]"; ?>" style="color:red;">Delete</a>
                ...
                if (isset($_GET["customer_id"])){
                 ...
                 $activity = "Deleted an customer account: Client ID: $id; Customer Name: $fullname at " . date("h:i:sa");
